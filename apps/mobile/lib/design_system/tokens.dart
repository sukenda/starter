...
abstract final class DsSpace { static const xs=4.0, sm=8.0, md=16.0, lg=24.0, xl=32.0; }
abstract final class DsRadius { static const sm=6.0, md=10.0, lg=14.0, xl=20.0; }
